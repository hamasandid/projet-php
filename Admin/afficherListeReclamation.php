    ...
    <body class="sb-nav-fixed">
		...
		<div class="table-responsive">
			...
			<tr align="center"> 
				<th>Identifiant</th>
				<th>nom du client</th>
				<th>N° Carte Identite</th>
				<th>email du client</th>
				<th>Votre Reclamation</th>
			...
			<tr>
				...
				<td><?php echo $reclamation['nomclient']; ?></td>
				<td><?php echo $reclamation['cin']; ?></td>
				<td><?php echo $reclamation['email']; ?></td>
				<td><?php echo $reclamation['texte']; ?></td>
				<td>
					
				</td>
				<td>
				<form method="POST" action="supprimerReclamation.php?id=<?php echo $reclamation['id']; ?>">
