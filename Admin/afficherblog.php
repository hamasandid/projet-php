...
include 'C:/xampp/htdocs/Cyjam/Controller/BlogC.php';
    //include '../config.php';
    ...
    <body class="sb-nav-fixed">
      ...
      <table class="table bordered">
                 ...
                 <tr>
                     ...
                     <th style="color: red;border-color:black">Titre</th>
                     <th style="color: red;border-color:black">Description</th>
                     <th style="color: red;border-color:black">Date</th>
                     <th style="color: red;border-color:black">Image</th>
                 ...
                 foreach($listeBlogs as $blog) {
                    if(empty($_GET['search']) || stripos($blog['titre'], $_GET['search']) !== false) {//boucle for w a7na fi kol blog 3ana titre w description w image w id 
                     ?>
                     <tr>
               <td style="color:black;border-color:black"><?php echo $blog['id']; ?></td>
                ...
                <td style="color:black;border-color:black"><?php echo $blog['description']; ?></td>
				<td style="color:black;border-color:black"><?php echo $blog['date']; ?></td>
                <?php echo "<td ><img src='upload/{$blog['image']}' width='50'></td>";
                                    echo "<td>";
                                    ?>
                ...
                <td>
					<form method="POST" action="modifierblog.php">
						<input type="submit" id="modifier"  value="Modifier" class="btn btn-primary" style="background-color:red;">
                ...
                <br>
                <center><button type="button" class="btn btn-primary" style="background-color:red;" onclick="exportPDF()">Export PDF</button></center>
                <br>
             <center> <button class="btn btn-primary" style="background-color: black;">  <a href="ajouterblog.php">AjouterBlog</a></button></center>
