<?php
    ...
    if (		
        ...
        if (			
            ...
            $SalleC->ModifierSalle($salles,$_GET["idS"]);
            header('Location:AfficherSalles.php?mess= Salle Modifé avec succés');
        }
        else
...
<script src="../Controle.js"></script>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Modifier Salle</h3></div>
                                    <div class="card-body">
                                    <div id="error">
            <?php echo $error; ?>
        </div>
		...
		<?php
			if (isset($_GET['idS'])){
				$salles = $SalleC->RecupererSalle($_GET['idS']);
    ...
    <form method="post" class="form"  enctype="multipart/form-data" id="form" onsubmit="return validateForm();" >
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="NomS" id="NomS" value="<?php echo $salles['NomS'];?>">
            ...
            <label class="col-sm-3 col-form-label "  >Nombre Places</label>
                <div class="col-sm-6">
                    <input type="number" class="form-control" name="NbPlaces" id="NbPlaces" value="<?php echo $salles['NbPlaces']; ?>">
             ...
             <div class="col-sm-3 d-grid">
                 <a class="btn btn-primary" href="AfficherSalles.php" role="button">Retour</a>
             </div>
          </div>
            </table>
        </form>
