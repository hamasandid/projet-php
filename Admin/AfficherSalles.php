                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <?php
                            ...
                            <table>
                                <thead>
                                    <td><a class="btn btn-primary" href="AjouterSalle.php" role="button">Nouveau Salle</a></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                
                                    <td><a class="btn btn-primary" href="AfficherFilm.php" role="button">Liste des Films</a></td>
                                </thead>
                            </table>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                    <tr>
                                        <td><?php echo $salles['idS']; ?></td>
                                        <td><?php echo $salles['NomS']; ?></td>
                                        <td><?php echo $salles['NbPlaces']; ?></td>
                                        <td>
                                            <form method="GET" action="ModifierSalle.php">
                                                <input type="submit"  class="btn btn-primary btn-sm" name="Modifier" value="Modifier">
                                                <input type="hidden"  value=<?php echo $salles['idS']; ?>  name="idS">  
                                            </form>
                                        </td>
                                        <td>
                                            <a  class="btn btn-danger btn-sm"   href="SupprimerSalle.php?idS=<?php echo $salles['idS']; ?>">Supprimer</a>
                                        </td>
                                    </tr>
                                    <?php
                                        }
