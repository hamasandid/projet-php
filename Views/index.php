...
<head>
    ...
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.1/css/all.css" integrity="sha384-5sAR7xN1Nv6T6+dT2mhtzEpVJvfS3NScPQTrOxhwjIuvcA67KV2R5Jz6kr4abQsz" crossorigin="anonymous">
        ...
        <link rel="stylesheet" href="stylecha.css">

        <link rel="stylesheet" href="css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="css/responsive.css"> <!--teb3a l partie lfou9aneya-->
      <!-- fevicon -->
               ...
               <div class="row">
                  <div class="col-md-12">
                     ...
                     <div id="banner1" class="carousel slide">
                              ...
                              <div class="carousel-caption relative">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="dream">
                                          <h1>
                                             regardez <br>votre <br>film <br>preferé
                                          </h1>
                        ...
                        <!-- controls ////les boutons li ymachiw o yjibou --> 
            ...
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>all starts with  <span class="blue_light">tunicult</span></h2>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  <div class="form">
                     <div class="searchbar">
                        <input class="search_input" type="text" name="" placeholder="Search film">
               ...
               <div class="col-md-10 offset-md-1">
                  <div class="domain_bg">
                     ...
                     <form action="" method="POST">
                        <div class="form-row">
                           <input type="text" placeholder="idclient" name="idclient">
                           <input type="text" placeholder="nom" name="nom">
                           <input type="text" placeholder="prenom" name="prenom">
                        </div>
                        <div class="form-row">
                           <input type="text" name="nomfilm" placeholder="nomfilm">
                           <input type="date" name="datefilm" id="datefilm" value="Y-m-d'">
                           <div class="form-row">
                     ...
                     <a class="read_more" href="liste_reservation.php">See More</a>
                  </div>
               </div>
            </div>
         </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>site divertissant</h3>
                        <p>votre meilleur destination pour se divertir et suivre les nouveautés de nos produits que vous trouverez ici !</p>
                     </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>Rapidité</h3>
                        <p>tuniculte vous garantie la rapidité de repondre et de reagir à vos besoins et remarques </p>
                     </div>
                     <a class="read_more" href="hosting.html">Read More</a>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>securité</h3>
                        <p>votre site vous garantie la securité de vos données  parlant avec d'autres personnes durant un film. </p>
                     </div>
                     <a class="read_more" href="hosting.html">Read More</a>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div id="ho_co" class="guarantee-box_main">
                     <div class="guarantee-box text_align_center">
                        ...
                        <h3>necessité</h3>
                        <p>tuniculte vous offre tous ce qu'il vous faut pour mieux regarder vos films et mieux les suivre.</p>
                     </div>
                     <a class="read_more" href="hosting.html">Read More</a>
                  </div>
               </div>
         ...
         <div class="container">
            <div class="row">
               <div class="col-md-8 offset-md-2">
                  <div class="titlepage text_align_center">
                     <h2>les avis de nos clients, <br> <span class="blue_light">en anonyme</span></h2>
                     <p>quelques clients fideles de tuniculte ont decidé de donner leurs avis et de parler de leurs experiences avec notre site
                     </p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        <h3>anonyme1</h3>
                        <p> avec <span>3</span>experiences </p>
                        <a href="Javascript:void(0)">achat</a>
                        <ul class="supp">
                           <li>j'ai achter qq </li>
                           <li>produit à travers</li>
                           <li>ce site qui etait</li>
                           <li>rapide et mis à jour</li>
                           <li>24/7 </li>
                        </ul>
                     </div>
                     <a class="read_more" href="Javascript:void(0)">donner avis</a>
                  </div>
               </div>
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        <h3>anonyme2</h3>
                        <p>avec <span>8</span> experiences</p>
                        <a href="Javascript:void(0)">cinema</a>
                        <ul class="supp">
                           <li>j'ai regarder qq</li>
                           <li>films dont j'ai reservé</li>
                           <li>et je me suis</li>
                           <li>amuser par cette</li>
                           <li>experience</li>
                        </ul>
                     </div>
                     <a class="read_more" href="Javascript:void(0)">donner avis</a>
               ...
               <div class="col-md-4">
                  <div id="ho_co" class="order-box_main">
                     <div class="order-box text_align_center">
                        <h3>anonyme3</h3>
                        <p>avec  <span>5</span> experiences</p>
                        <a href="Javascript:void(0)">produit</a>
                        <ul class="supp">
                           <li>j'ai reservé qq</li>
                           <li>produits differents</li>
                           <li>pendant une longue</li>
                           <li>periode et ça n'a</li>
                           <li>rien affecter pour ma reservation</li>
                        </ul>
                     </div>
                     <a class="read_more" href="Javascript:void(0)">donner avis</a>
                  </div>
      ...
      <div class="about">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>A propos <span class="blue_light">cinema</span></h2>
                  </div>
               </div>
               <div class="col-md-10 offset-md-1">
                  <div class="about_img text_align_center">
                     ...
                     <p>
                        Les flux audio ou vidéo de streaming sont généralement fournis par des plateformes qui proposent des films, séries (vidéos à la demande) , ce qui est devenu plus pratique de nos jours .C'est pour cela qu'on vous offre la meilleure experience streaming avec reservation en avance ,si vous voulez biensur,et en parlant avec peut importe qui durant le film.
                     </p>
      ...
      <div class="contact">
         <div class="container">
            <div class="row ">
               <div class="col-md-12">
                  <div class="titlepage text_align_center">
                     <h2>vos<span class="blue_light">reclamations</span></h2>
                  </div>
               </div>
               <div class="col-md-10 offset-md-1">
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6">
                     <div class="infoma">
                        <h3>Get Support.</h3>
                        <ul class="conta">
                           <li><i class="fa fa-map-marker" aria-hidden="true"></i>Address : Loram  
                           </li>
                           <li><i class="fa fa-phone" aria-hidden="true"></i>Call : +216 50962694</li>
                           <li> <i class="fa fa-envelope" aria-hidden="true"></i><a href="Javascript:void(0)"> Email : tuniculte@gmail.com</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="infoma">
                        ...
                        <ul class="menu_footer">
                           ...
                           <li><a href="about.html">cinema </a></li>
                           <li><a href="domain.html">produit</a></li>
                           <li><a href="hosting.html">reservation</a></li>
                           <li><a href="contact.html">commande</a></li>
                        </ul>
                     </div>
                  </div>
...
<html>
 ...
 <body>
  <br />
  <h2 align="center"><a href="#"> reservation calendar</a></h2>
  <br />
  <div class="container">
   <div id="calendar"></div>
  </div>
